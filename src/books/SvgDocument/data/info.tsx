...
export const svgDocumentConfig = {
  /** 标题 */
  title: "SVG组件文档",
  slug: routerPaths.svgDocument,
  /** 描述 */
  description: "SVG 组件使用指南和示例",
  /** 图标（JSX） */
  icon: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-full h-full" preserveAspectRatio="xMidYMid meet" aria-hidden>
      <title>file_type_svg</title>
      <path d="M7.674,14.488a2.218,2.218,0,1,0,0,3.137H24.326a2.218,2.218,0,1,0,0-3.137Z" style={{fill:"#ffb13b",stroke:"#000",strokeWidth:"3.73px"}}/>
      <path d="M11.222,9.06A2.218,2.218,0,1,0,9,11.278L20.778,23.052A2.218,2.218,0,1,0,23,20.834Z" style={{fill:"#ffb13b",stroke:"#000",strokeWidth:"3.73px"}}/>
      <path d="M17.568,7.73a2.218,2.218,0,1,0-3.137,0V24.382a2.218,2.218,0,1,0,3.137,0Z" style={{fill:"#ffb13b",stroke:"#000",strokeWidth:"3.73px"}}/>
      <path d="M23,11.278A2.218,2.218,0,1,0,20.778,9.06L9,20.834a2.218,2.218,0,1,0,2.218,2.218Z" style={{fill:"#ffb13b",stroke:"#000",strokeWidth:"3.73px"}}/>
