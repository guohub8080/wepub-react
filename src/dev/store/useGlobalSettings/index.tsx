...
export const globalSettingsStore = create<GlobalSettingsState>()(
  persist(
    (set) => ({
      ...
      resetBookSettings: () => set({
        bookSideWidth: DEFAULT_VALUES.bookSideWidth,
        bookContentWidth: DEFAULT_VALUES.bookContentWidth,
        bookContentPadding: DEFAULT_VALUES.bookContentPadding,
        bookSideContentGap: DEFAULT_VALUES.bookSideContentGap,
        isBookTocShow: DEFAULT_VALUES.isBookTocShow,
      }),
    }),
    {
      ...PERSIST_CONFIG,
