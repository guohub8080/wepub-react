...
const result = genSvgKeys({
  initValue: 0,
  timeline: [
    { keySpline: '0.42 0 0.58 1', toValue: 100, durationSeconds: 2 },
    { keySpline: '0 0 0.58 1', toValue: 200, durationSeconds: 3 }
  ]
});
...
const animConfig = genSvgKeys({
  ...
  timeline: [
    { keySpline: '0.42 0 0.58 1', toValue: 100, durationSeconds: 2 },
    { keySpline: '0 0 1 1', toValue: 0, durationSeconds: 1 }
  ]
});
...
| `durationSeconds` | `number` | 是 | 该段的持续时间（秒） |
...
每个时间线段使用**相对时间跨度**（durationSeconds）而不是绝对时间戳，更符合直觉：

```typescript
const config = genSvgKeys({
  initValue: 0,
  timeline: [
    { keySpline: '0 0 1 1', toValue: 50, durationSeconds: 1 },   // 0-1秒：0→50
    { keySpline: '0 0 1 1', toValue: 100, durationSeconds: 2 },  // 1-3秒：50→100
    { keySpline: '0 0 1 1', toValue: 0, durationSeconds: 1 }     // 3-4秒：100→0
  ]
});
// totalDuration: 4 秒
```
...
函数会根据每段的 `durationSeconds` 自动计算相对时间比例：

```typescript
const config = genSvgKeys({
  initValue: 0,
  timeline: [
    { keySpline: '0 0 1 1', toValue: 100, durationSeconds: 2 },  // 占总时长的 2/5
    { keySpline: '0 0 1 1', toValue: 200, durationSeconds: 3 }   // 占总时长的 3/5
  ]
});
// keyTimes: "0.000000;0.400000;1.000000"
// (0秒=0, 2秒=0.4, 5秒=1)
...
genSvgKeys({
  initValue: 0,
  timeline: [{ keySpline: '0 0 1 1', toValue: 100, durationSeconds: 2 }]
});
...
genSvgKeys({
  initValue: '#ff0000',
  timeline: [
    { keySpline: '0.25 0.1 0.25 1', toValue: '#00ff00', durationSeconds: 2 },
    { keySpline: '0.25 0.1 0.25 1', toValue: '#0000ff', durationSeconds: 2 }
  ]
});
...
genSvgKeys({
  ...
  timeline: [
    { keySpline: '0.42 0 0.58 1', toValue: 'M 0 0 L 100 100', durationSeconds: 3 }
  ]
});
```
...
const xAnim = genSvgKeys({
  initValue: 0,
  timeline: [
    { keySpline: '0.42 0 0.58 1', toValue: 200, durationSeconds: 2 },  // 右移
    { keySpline: '0.42 0 0.58 1', toValue: 0, durationSeconds: 2 }     // 左移
  ]
});
...
const opacityAnim = genSvgKeys({
  initValue: 0,
  timeline: [
    { keySpline: '0 0 0.58 1', toValue: 1, durationSeconds: 1 },    // 淡入
    { keySpline: '0 0 1 1', toValue: 1, durationSeconds: 2 },       // 保持
    { keySpline: '0.42 0 1 1', toValue: 0, durationSeconds: 1 }     // 淡出
  ]
});
```
...
const colorAnim = genSvgKeys({
  initValue: '#ff0000',
  timeline: [
    { keySpline: '0.25 0.1 0.25 1', toValue: '#ffff00', durationSeconds: 1 },
    { keySpline: '0.25 0.1 0.25 1', toValue: '#00ff00', durationSeconds: 1 },
    { keySpline: '0.25 0.1 0.25 1', toValue: '#00ffff', durationSeconds: 1 },
    { keySpline: '0.25 0.1 0.25 1', toValue: '#0000ff', durationSeconds: 1 },
    { keySpline: '0.25 0.1 0.25 1', toValue: '#ff00ff', durationSeconds: 1 },
    { keySpline: '0.25 0.1 0.25 1', toValue: '#ff0000', durationSeconds: 1 }
  ]
});
```
...
const scaleAnim = genSvgKeys({
  initValue: 1,
  timeline: [
    { keySpline: '0.42 0 0.58 1', toValue: 1.2, durationSeconds: 1 },  // 放大
    { keySpline: '0.42 0 0.58 1', toValue: 1, durationSeconds: 1 }     // 缩小
  ]
});
...
const xAnim = genSvgKeys({
  ...
  timeline: [
    { keySpline: '0.42 0 0.58 1', toValue: 100, durationSeconds: 2 },
    { keySpline: '0.42 0 0.58 1', toValue: 200, durationSeconds: 2 }
  ]
});
...
const yAnim = genSvgKeys({
  initValue: 0,
  timeline: [
    { keySpline: '0.42 0 0.58 1', toValue: 50, durationSeconds: 1 },
    { keySpline: '0 0 1 1', toValue: 50, durationSeconds: 2 },
    { keySpline: '0.42 0 0.58 1', toValue: 100, durationSeconds: 1 }
  ]
});
...
const opacityAnim = genSvgKeys({
  initValue: 0,
  timeline: [
    { keySpline: '0 0 0.58 1', toValue: 1, durationSeconds: 1 },
    { keySpline: '0 0 1 1', toValue: 1, durationSeconds: 2 },
    { keySpline: '0.42 0 1 1', toValue: 0, durationSeconds: 1 }
  ]
});
...
3. **逻辑错误**
   - 总时长为 0 或负数（所有 durationSeconds 之和 ≤ 0）

### 技术细节

- **时间精度**：keyTimes 保留 6 位小数
- **贝塞尔验证**：自动验证贝塞尔参数格式（必须是 4 个有效数字）
- **时间累加**：自动累加每段的 durationSeconds 计算总时长和相对时间

### 注意事项

1. **时间跨度必须为正数**：每个 durationSeconds 应该大于 0
...
const anim = genSvgKeys({
  ...
  timeline: [
    { keySpline: '0.42 0 0.58 1', toValue: 100, durationSeconds: 2 },
    { keySpline: '0 0 1 1', toValue: 100, durationSeconds: 2 },
    { keySpline: '0.42 0 0.58 1', toValue: 200, durationSeconds: 2 }
  ]
});
