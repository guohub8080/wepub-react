 ...
 *   initScale: 1,
 *   timeline: [
 *     { durationSeconds: 1, toScale: 1.5 },
 *     { durationSeconds: 1, toScale: 1 }
 *   ]
 * })
 * 
 * // 呼吸缩放（无限循环）
 ...
 *   initScale: 1,
 *   timeline: [
 *     { durationSeconds: 1.5, toScale: 1.2 },
 *     { durationSeconds: 1.5, toScale: 1 }
 *   ],
 *   loopCount: 0
 * })
 * 
 * // 点击触发动画
 * genAnimateScale({
 *   timeline: [{ durationSeconds: 1, toScale: 1.5 }],
 ...
 *   initScale: 1,
 *   timeline: [
 *     { durationSeconds: 0.5, toScale: 1.3 },  // 放大
 *     { durationSeconds: 2 },                   // 保持 2 秒
 *     { durationSeconds: 0.5, toScale: 1 }     // 还原
 *   ],
 *   loopCount: 0
 * })
 * 
 ...
 * genAnimateScale({
 *   timeline: [
 *     { durationSeconds: 1, toScale: 1.5, keySplines: '0.68 -0.55 0.265 1.55' }
 *   ]
 * })
 * ```
 */
