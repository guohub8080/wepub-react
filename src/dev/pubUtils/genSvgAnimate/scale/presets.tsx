...
export const scalePresets = {
  ...
  growGentle: (duration: number = 0.3) =>
    genAnimateScale({
      timeline: [{ durationSeconds: duration, toValue: 1.1 }],
  ...
  growNormal: (duration: number = 0.5) =>
    genAnimateScale({
      timeline: [{ durationSeconds: duration, toValue: 1.2 }],
      isBeginWithClick: true,
      freeze: true,
    }),
  ...
  growStrong: (duration: number = 0.8) =>
    genAnimateScale({
      timeline: [{ durationSeconds: duration, toValue: 1.5 }],
      isBeginWithClick: true,
      freeze: true,
    }),
  ...
  growFast: () =>
    genAnimateScale({
      timeline: [{ durationSeconds: 0.2, toValue: 1.3 }],
      isBeginWithClick: true,
      freeze: true,
    }),
  ...
  shrink: (duration: number = 0.5) =>
    genAnimateScale({
      timeline: [{ durationSeconds: duration, toValue: 0.8 }],
      isBeginWithClick: true,
      freeze: true,
    }),
  ...
  breathe: (minScale: number = 0.95, maxScale: number = 1.05, duration: number = 2) =>
    genAnimateScale({
      initScale: maxScale,
      timeline: [
        { durationSeconds: duration, toValue: minScale },
        { durationSeconds: duration, toValue: maxScale },
      ],
      loopCount: 0,
    }),
  ...
  pulse: (pulseScale: number = 1.2, duration: number = 0.5) =>
    genAnimateScale({
      timeline: [
        { durationSeconds: duration / 2, toValue: pulseScale },
  ...
  heartbeat: () =>
    genAnimateScale({
      timeline: [
        { durationSeconds: 0.15, toValue: 1.2 },
        { durationSeconds: 0.15, toValue: 1 },
        { durationSeconds: 0.15, toValue: 1.2 },
        { durationSeconds: 0.15, toValue: 1 },
  ...
  shake: (intensity: number = 0.1, duration: number = 0.5) =>
    genAnimateScale({
      timeline: [
        { durationSeconds: duration / 6, toValue: 1 - intensity },
        { durationSeconds: duration / 6, toValue: 1 + intensity },
        { durationSeconds: duration / 6, toValue: 1 - intensity },
        { durationSeconds: duration / 6, toValue: 1 + intensity },
        { durationSeconds: duration / 6, toValue: 1 - intensity },
        { durationSeconds: duration / 6, toValue: 1 },
      ],
      calcMode: 'linear',
    }),
  ...
  wave: (duration: number = 4) =>
    genAnimateScale({
      timeline: [
        { durationSeconds: duration / 4, toValue: 1.1 },
        { durationSeconds: duration / 4, toValue: 0.9 },
        { durationSeconds: duration / 4, toValue: 1.1 },
  ...
  growStayShrink: (growDur: number = 0.5, stayDur: number = 2, shrinkDur: number = 0.5) =>
    genAnimateScale({
      timeline: [
        { durationSeconds: growDur, toValue: 1.3 },
        { durationSeconds: stayDur },  // 保持放大
        { durationSeconds: shrinkDur, toValue: 1 },
      ],
      loopCount: 0,
    }),
  ...
  flash: () =>
    genAnimateScale({
      timeline: [
        { durationSeconds: 0.1, toValue: 1.5 },
        { durationSeconds: 0.1, toValue: 1 },
        { durationSeconds: 0.1, toValue: 1.5 },
        { durationSeconds: 0.1, toValue: 1 },
      ],
    }),
  ...
  progressiveGrow: (duration: number = 2) =>
    genAnimateScale({
      timeline: [
        { durationSeconds: duration / 3, toValue: 1.1 },
        { durationSeconds: duration / 3, toValue: 1.3 },
        { durationSeconds: duration / 3, toValue: 1.5 },
      ],
      freeze: true,
    }),
  ...
  progressiveShrink: (duration: number = 2) =>
    genAnimateScale({
      timeline: [
        { durationSeconds: duration / 3, toValue: 0.9 },
        { durationSeconds: duration / 3, toValue: 0.7 },
        { durationSeconds: duration / 3, toValue: 0.5 },
      ],
      freeze: true,
    }),
};
