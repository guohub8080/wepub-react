...
export const rotatePresets = {
  ...
  clockwise: (duration: number = 2) =>
    genAnimateRotate({
      timeline: [{ durationSeconds: duration, toValue: 360 }],
      loopCount: 0,
    }),
  ...
  fast: () =>
    genAnimateRotate({
      timeline: [{ durationSeconds: 1, toValue: 360 }],
      loopCount: 0,
    }),
  ...
  slow: () =>
    genAnimateRotate({
      timeline: [{ durationSeconds: 4, toValue: 360 }],
      loopCount: 0,
    }),
  ...
  flip: (duration: number = 0.6) =>
    genAnimateRotate({
      timeline: [{ durationSeconds: duration, toValue: 180, keySplines: '0.68 -0.55 0.265 1.55' }],
      freeze: true,
    }),
  ...
  spin: (duration: number = 0.8) =>
    genAnimateRotate({
      timeline: [{ durationSeconds: duration, toValue: 360, keySplines: '0.68 -0.55 0.265 1.55' }],
      freeze: true,
    }),
  ...
  elastic: (angle: number = 360, duration: number = 1) =>
    genAnimateRotate({
      timeline: [{ durationSeconds: duration, toValue: angle, keySplines: '0.68 -0.55 0.265 1.55' }],
      freeze: true,
    }),
  ...
  accelerate: (duration: number = 2) =>
    genAnimateRotate({
      timeline: [{ durationSeconds: duration, toValue: 360, keySplines: '0.55 0.055 0.675 0.19' }],
      loopCount: 0,
    }),
  ...
  decelerate: (duration: number = 2) =>
    genAnimateRotate({
      timeline: [{ durationSeconds: duration, toValue: 360, keySplines: '0.215 0.61 0.355 1' }],
      loopCount: 0,
    }),
  ...
  pendulum: (maxAngle: number = 45, duration: number = 2) =>
    genAnimateRotate({
      initAngle: maxAngle,
      timeline: [
        { durationSeconds: duration / 2, toValue: -maxAngle, keySplines: '0.42 0 0.58 1' },
        { durationSeconds: duration / 2, toValue: maxAngle, keySplines: '0.42 0 0.58 1' },
      ],
      loopCount: 0,
    }),
