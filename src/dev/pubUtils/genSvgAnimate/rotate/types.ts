...
export interface RotateAnimationConfig {
   ...
   * timeline: [
   *   { toValue: 90, durationSeconds: 1 },   // 旋转90度
   *   { toValue: 0, durationSeconds: 1 },    // 保持不动
   *   { toValue: 45, durationSeconds: 1 }    // 再旋转45度（总共135度）
   * ]
   *
   * // 绝对旋转模式 (isRelativeRotate: false)
   * timeline: [
   *   { toValue: 90, durationSeconds: 1 },   // 旋转到90度
   *   { toValue: 90, durationSeconds: 1 },   // 保持在90度
   *   { toValue: 135, durationSeconds: 1 }   // 旋转到135度
   * ]
   */
