 ...
 *   initAngle: 0,
 *   timeline: [
 *     { durationSeconds: 2, toAngle: 180 },
 *     { durationSeconds: 1, toAngle: 360 }
 *   ]
 * })
 * 
 * // 往返旋转（无限循环）
 ...
 *   initAngle: 0,
 *   timeline: [
 *     { durationSeconds: 1.5, toAngle: 180 },  // 转到 180°
 *     { durationSeconds: 1.5, toAngle: 0 }     // 转回 0°
 *   ],
 *   loopCount: 0
 * })
 * 
 ...
 *   initAngle: 0,
 *   timeline: [
 *     { durationSeconds: 1, toAngle: 360 },    // 旋转
 *     { durationSeconds: 2 },                   // 保持 2 秒
 *     { durationSeconds: 1, toAngle: 0 }       // 返回
 *   ],
 *   loopCount: 0
 * })
 * 
 ...
 * genAnimateRotate({
 *   timeline: [
 *     { durationSeconds: 1, toAngle: 360, keySplines: '0.68 -0.55 0.265 1.55' }
 *   ]
 * })
 * ```
 */
