...
const INPUT_FILE = path.resolve(__dirname, './SourceHanSansJP-VF.ttf');
...
// 3. 字体基础信息配置
const FONT_CONFIG = {
    family: 'syht-jp-v',          // CSS 中使用的字体名称
    localFamily: ['syht-jp-v'], // 优先匹配用户本地安装的字体
...
async function build() {
    ...
    try {
        await fontSplit({
            ...
            // 这里加上前缀 misans-vf-
            renameOutputFont: 'syht-jp-v-[index].[ext]',
