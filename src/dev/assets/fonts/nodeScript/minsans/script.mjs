...
const INPUT_FILE = path.resolve(__dirname, './MiSansVF.ttf');
...
// 3. 字体基础信息配置
const FONT_CONFIG = {
    family: 'minsans-v',          // CSS 中使用的字体名称
    localFamily: ['minsans-v'], // 优先匹配用户本地安装的字体
...
async function build() {
    ...
    try {
        await fontSplit({
            ...
            // 这里加上前缀 misans-vf-
            renameOutputFont: 'misans-v-[index].[ext]',
