...
const AIECOArticleFrame = (props: ArticleFrameProps) => {
    const borderRadius = byDefault(props.borderRadius, 8);
    const borderColor = "#d1d5db";
    const articleBgColor = byDefault(props.articleBgColor, wechatColors.lightBgBlue);
...
export default AIECOArticleFrame;
