...
const AnyPushLoop = (props: {
    ...
    const getTimeLineByIndex = (picIndex: number) => {
        ...
        return [
            { toValue: entryValue, durationSeconds: currentPic.switchDuration, keySplines: currentPic.keySplines },
            { toValue: { x: 0, y: 0 }, durationSeconds: currentPic.stayDuration },
            { toValue: exitValue, durationSeconds: nextPic.switchDuration, keySplines: nextPic.keySplines },
            { toValue: { x: 0, y: 0 }, durationSeconds: getHoldTimeByIndex(picIndex) }
        ];
    };
